...
TestWindow::TestWindow()
 : BWindow(BRect(100,100,900,600),"LayeringWindow",B_TITLED_WINDOW_LOOK ,B_NORMAL_WINDOW_FEEL,  B_ASYNCHRONOUS_CONTROLS | B_NOT_ZOOMABLE | B_NOT_RESIZABLE |  B_NOT_MINIMIZABLE, B_CURRENT_WORKSPACE)
{
	...
	splitView = new BViewSplitter(Bounds(),B_HORIZONTAL, B_FOLLOW_ALL, B_WILL_DRAW);
